...
|---|---|---|---|
| `crates/core` | Domain | Pure financial formulas and shared types | ✅ Implemented (35 formulas) |
...
Public paths (`/healthz`, `/openapi.json`, `/swagger-ui/*`) are always accessible.
...
- **General**: Future Value, Present Value, Annuity FV/PV, Perpetuity PV, Effective Annual Rate, Amortization Payment, Amortization Schedule
- **Financial Ratios**: ROE, ROA, DuPont ROE, Current Ratio, Debt-to-Equity
- **Banking**: Net Interest Margin, Loan-to-Deposit Ratio
- **Markets**: Sharpe Ratio, Jensen's Alpha, Simple Moving Average
- **Stocks & Bonds**: Dividend Discount Model, Bond Price, Yield-to-Maturity Approximation
